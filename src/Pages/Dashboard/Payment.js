...
const Payment = () => {
    const { id } = useParams();
    const url = `https://dry-everglades-70215.herokuapp.com/booking/${id}`
        ...
        <div>
            <div class="card w-50 max-w-md bg-base-100 shadow-xl my-12">
                <div class="card-body">
                    ...
                    <p>Your Appointment <span className="text-primary">{appointment.date}</span> at {appointment.slot}</p>
